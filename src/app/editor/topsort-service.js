(function() {
  ...
  function Topsortservice() {
    /**
     * @returns An array of node ids as string. ['idOfFirstNode', 'idOfSecondNode', ...]. 
     * Tbis is not exactly the best way to return ids, but until now there is no need for a better return.
     */
